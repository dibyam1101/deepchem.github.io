...
export default function ModelCard({ model }) {
    return (
        <>
            <Link href={model.url}>
                <div className="flex flex-col items-start py-4 px-5 gap-4 bg-[#FFFFFF] shadow-[0_4px_4px_rgba(0,0,0,0.25)] rounded-lg w-96">
                    <div className="flex flex-row justify-between items-center gap-2.5">
                        ...
                        <div className="flex flex-row items-center py-1.5 px-3 bg-[rgba(235, 235, 235, 0.15)] rounded-md">
                    ...
                    <div className="text-base font-medium text-[#3A6EA5]">
